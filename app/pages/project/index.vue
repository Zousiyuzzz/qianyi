    ...
    >
      ...
      >
        <view class="item-header">
          ...
          <view class="item-status status-active">
            进行中
          </view>
        </view>
        ...
        <view class="item-content">
          ...
          <view class="item-row">
            ...
            <text class="value">{{ item.businessPerson_dictText || '-' }}</text>
          </view>
          <view class="item-row">
            <text class="label">运营方式：</text>
            <text class="value">{{ getOperationTypeText(item.operationType) }}</text>
          </view>
          <view class="item-row">
            <text class="label">合作方式：</text>
            <text class="value">{{ item.collaborationMode_dictText || '-' }}</text>
          </view>
          <view class="item-row">
        ...
        <view class="item-actions">
          <button class="action-btn" @click.stop="handleFundPool(item)">资金池</button>
...
export default {
  ...
  methods: {
    ...
    handleFundPool(item) {
      uni.navigateTo({
        url: `/pages/project/fundPool?proId=${item.id}&proName=${encodeURIComponent(item.proName || '')}`
      })
    },
