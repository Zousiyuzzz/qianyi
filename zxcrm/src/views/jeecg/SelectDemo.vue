      ...
      <a-form-model ref="form" :model="formData" layout="inline">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="性别2" prop="sex2">
              <j-dict-select-tag v-model="formData.sex2" type="radioButton" title="性别2" dictCode="sex"
                placeholder="请选择性别2" />
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="字典搜索多选(同步)" prop="searchMultipleValue">
              <j-search-select-tag placeholder="请做出你的选择" v-model="formData.searchMultipleValue"
                :dictOptions="searchOptions" mode="multiple">
              </j-search-select-tag>
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="字典搜索(异步)" prop="asyncSelectValue">
              <j-search-select-tag placeholder="请做出你的选择" v-model="formData.asyncSelectValue"
                dict="sys_depart,depart_name,id" :pageSize="6" :async="true">
              </j-search-select-tag>
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="字典搜索多选(异步)" prop="asyncMultipleValue">
              <j-search-select-tag placeholder="请做出你的选择" v-model="formData.asyncMultipleValue"
                dict="sys_depart,depart_name,id" :pageSize="6" :async="true" mode="multiple">
              </j-search-select-tag>
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="字典下拉(多选)" prop="selMuti">
              <j-multi-select-tag v-model="formData.selMuti" dictCode="sex" placeholder="请选择">
              </j-multi-select-tag>
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="选择部门 自定义返回值" prop="orgCodes">
              <j-select-depart v-model="formData.orgCodes" :trigger-change="true" customReturnField="orgCode"
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="代码输入框" style="min-height: 120px" prop="jCodeEditor">
              <j-code-editor language="javascript" v-model="formData.jCodeEditor" :fullScreen="true"
        ...
        <a-row :gutter="24">
          <a-col>
            ...
            <j-modal :visible.sync="modal.visible" :width="1200" :title="modal.title"
              :fullscreen.sync="modal.fullscreen" :switchFullscreen="modal.switchFullscreen">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="下拉树选择" prop="treeSelect">
              <j-tree-select v-model="formData.treeSelect" placeholder="请选择菜单" dict="sys_permission,name,id"
                pidField="parent_id" hasChildField="is_leaf" pidValue="" />
            </a-form-model-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-model-item label="下拉树多选" prop="treeSelectMultiple">
              <j-tree-select v-model="formData.treeSelectMultiple" placeholder="请选择菜单" dict="sys_permission,name,id"
                pidField="parent_id" hasChildField="is_leaf" pidValue="" multiple />
            </a-form-model-item>
          </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      jCheckboxOptions: [
        { label: 'ZX_CRM', value: 'jeecg' },
        { label: 'ZX_CRM-Boot', value: 'jeecgboot' },
