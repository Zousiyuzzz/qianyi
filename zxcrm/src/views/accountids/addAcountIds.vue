<template>
    <a-modal title="添加账户" :visible="visible" :confirm-loading="confirmLoading" @ok="handleOk" @cancel="handleCancel"
            ...
            <j-form-container :disabled="formDisabled">
                <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
                    <a-row :gutter="16">
                        ...
                        <a-col :span="24">
                            <a-form-model-item label="代理商" :labelCol="{ span: 4 }" :wrapperCol="{ span: 20 }"
                                prop="agentId">
...
export default {
    ...
    data() {
        return {
            ...
            validatorRules: {
                ...
                // sagentId: [{ required: true, message: '请选择代理商' }],
    ...
    methods: {
        ...
        // 获取代理商字典配置
        getAgentDictConfig() {
            // 如果是泛媒体，去掉channel_sign条件（因为泛媒体包含多个渠道）
            if (this.Sign === 'CJHC,BLBL,WYMS') {
                return `tab_advertiser_info,advertiser_name,id,del_flag = '0'`
            }
            // 其他情况使用等号查询
            return `tab_advertiser_info,advertiser_name,id,del_flag = '0' and channel_sign = '${this.Sign}'`
        }
    },
