...
const whiteList = ['/user/login', '/user/register', '/user/register-result', '/user/alteration', '/accountids/copy', '/tools/ai/index', '/tools/nopermission/ai', '/projectManager/workbench'] // no redirect whitelist
