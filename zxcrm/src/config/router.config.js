import { UserLayout, TabLayout, RouteView, BlankLayout, PageView, WorkbenchLayout } from '@/components/layouts'
...
export const asyncRouterMap = [

  {
    ...
    children: [
      {
        path: '/dashboard/data-comparison',
        name: 'DataComparison',
        component: () => import('@/views/dashboard/DataComparison'),
        meta: { title: '数据对比报表', permission: ['dashboard'] }
      },
...
export const constantRouterMap = [
  {
    path: '/tools/nopermission/ai',
    name: 'ai',
    component: () => import('@/views/tools/nopermission/ai')
  },
  {
    path: '/user',
  ...
  },
  {
    ...
    children: [
      , {
        path: '/projectManager/workbench',
        name: 'ProjectWorkbench',
        component: () => import('@/views/projectManager/modules/Workbench.vue'),
        meta: { title: '工作台' }
      }
    ]
  },
  ...
  },
  {
    path: '/tools/nopermission/ai',
    component: BlankLayout,
    // redirect: '/tools/nopermission/ai',
    children: [
      {
        path: 'home',
        name: 'TestHome',
  ...
  },
  {
    ...
    name: 'jeecg',
    component: RouteView,
    redirect: '/jeecg/helloworld',
    meta: { title: '在线开发', icon: 'code' },
    children: [
      {
